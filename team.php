	...
	<div class="container">
		<div id="page">
			<div class="content">
				...
				<ul id="team">
					<li class="g1_5">
						<div class="pic"><img src="/img/team/christopher-kennedy.jpg"/></div>
						<div class="bio">
							<h3>Kennedy</h3>
							<ul class="links">
								...
								<li><a href="https://www.statuschart.com/kennedysgarage" class="statuschart"><img src="/img/team/statuschart-20x20.png"></a></li>
							</ul>
							<h4>UX Strategist</h4>
						</div><!--/bio-->
					</li>
					<li class="g1_5">
						<div class="pic"><img src="/img/team/aaron-hall.jpg"/></div>
						<div class="bio">
							<h3>Aaron Hall</h3>
							<ul class="links">
					...
					<li class="g1_5">
						<div class="pic"><img src="/img/team/tim-smith.png"/></div>
						<div class="bio">
							<h3>Tim Smith</h3>
							<ul class="links">
								...
								<li><a href="https://www.statuschart.com/timothybsmith" class="statuschart"><img src="/img/team/statuschart-20x20.png"></a></li>
							</ul>
							<h4>Designer</h4>
						</div><!--/bio-->
					</li>
					<li class="g1_5">
						<div class="pic"><img src="/img/team/jarod-reyes.jpg"/></div>
						<div class="bio">
							<h3>Jarod Reyes</h3>
							<ul class="links">
					...
					<li class="g1_5">
						<div class="pic"><img src="/img/team/frank-denbow.jpg"/></div>
						<div class="bio">
							<h3>Frank Denbow</h3>
							<ul class="links">
								<li><a href="https://twitter.com/FrankDenbow" class="twitter"><i class="ss-icon ss-social">&#xF611;</i></a></li>
								<li><a href="https://www.statuschart.com/frank" class="statuschart"><img src="/img/team/statuschart-20x20.png"></a></li>
							</ul>
							<h4>iOS Developer</h4>
						</div><!--/bio-->
					</li>
					<li class="g1_5">
						<div class="pic"><img src="/img/team/jon-gottfried.jpg"/></div>
						<div class="bio">
							<h3>Jon Gottfried</h3>
							<ul class="links">
								...
								<li><a href="https://www.statuschart.com/jonmarkgo" class="statuschart"><img src="/img/team/statuschart-20x20.png"></a></li>
							</ul>
							<h4>Developer</h4>
						</div><!--/bio-->
					</li>
					...
					<li class="g1_5">
						<div class="pic"><img src="/img/team/sara-kennedy.jpg"/></div>
						<div class="bio">
							<h3>Sara Kennedy</h3>
							<ul class="links">
					...
					<li class="g1_5">
						<div class="pic"><img src="/img/team/justin-lamonica.jpg"/></div>
						<div class="bio">
